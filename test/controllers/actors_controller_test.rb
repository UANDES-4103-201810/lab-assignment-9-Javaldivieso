...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post actors_url, params: { actor: { birth_date: @actor.birth_date, description: @actor.description, fist_name: @actor.fist_name, last_name: @actor.last_name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { birth_date: @actor.birth_date, description: @actor.description, fist_name: @actor.fist_name, last_name: @actor.last_name } }
